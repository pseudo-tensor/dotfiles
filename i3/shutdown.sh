...
LOCKSCRIPT="~/.i3/i3lock-extra -m pixelize"
...
ROFI_OPTIONS="-width 30 -location 0 -yoffset 0 -xoffset 0 -hide-scrollbar -bw 2"
...
function prepare_launcher() {
  if [[ "$1" == "rofi" ]]; then
    launcher_exe="rofi"
    launcher_options=$(echo "-dmenu -i -lines ${menu_nrows} -p ${ROFI_TEXT} \
      ${ROFI_OPTIONS}")
  elif [[ "$1" == "zenity" ]]; then
    launcher_exe="zenity"
